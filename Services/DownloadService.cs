...
namespace YoutubeSearcher.Services
{
    public class DownloadService
    {
        ...
        public async Task<string> DownloadVideoAsync(VideoInfo videoInfo, string format = "mp3", IProgress<double>? progress = null)
        {
            try
            {
        ...
        public async Task<List<string>> DownloadVideosAsync(List<VideoInfo> videos, string format = "mp3", IProgress<(int current, int total)>? progress = null)
        {
            ...
            foreach (var video in videos)
            {
                try
                {
                    ...
                    var filePath = await DownloadVideoAsync(video, format, progressReporter);
